...
app = Flask("app")
app.config["SQLALCHEMY_DATABASE-URI"] = "sqlite:///villian.db"
db = SQLAlchemy(app) 
...
def add_villain():
  return render_template("addvillain.html", error=[])
...
def add_user():
  ...
  if not description:
    errors.append("Oops! Looks like your forgot a description!")
  interests = request.form.get("interests")
  if not interests:
    error.append("Oops! Looks like you forgot some interests!")
  url = request.form.get("url")
  if not url:
    error.url("OOps! Looks like you forgot an image!")
